...
// TTLs específicos do auth-service
export const REDIS_TTL = {
  REFRESH_TOKEN: 60 * 60 * 24 * 7, // 7 dias
  ACCESS_TOKEN_BLACKLIST: 60 * 15,  // 15 minutos (igual ao JWT_EXPIRES_IN)
...
export async function cacheSet(
  ...
  try {
    ...
    const ttlToUse = ttl || REDIS_TTL.REFRESH_TOKEN;
